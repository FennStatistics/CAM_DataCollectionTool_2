...
$(function () {
    ...
    $('#inptextnode').on("input", function () {
        var MaxNumWords = store.config.MaxNumWords; // allow not more than X words
        var MaxLengthChars = store.config.MaxLengthChars; // allow not more than X characters
        ...
        if(store.cam.currentNode.isTextChangeable){
            ...
            if (numWords <= MaxNumWords && this.value.length <= MaxLengthChars) {
                ...
                toastr.warning(store.language.ndw_01tooManyWords, store.language.ndw_02tooManyWords + MaxNumWords + store.language.ndw_03tooManyWords, {
                    closeButton: true,
                    timeOut: 2000,
                ...
                toastr.warning(store.language.ndw_01tooManyWords, store.language.ndw_02tooManyWords + MaxLengthChars + store.language.ndw_03tooManyWordsA, {
                    closeButton: true,
                    timeOut: 2000,
                    positionClass: "toast-top-center",
                    preventDuplicates: true
            ...
            toastr.info(store.language.ndw_01predefinedConcept, store.language.ndw_02predefinedConcept, {
                closeButton: true,
                timeOut: 2000,
                positionClass: "toast-top-center",
                preventDuplicates: true
